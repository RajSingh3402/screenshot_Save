...
export function EditServer({ server, onBack, onSave, isSaving }: EditServerProps) {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 page-container" style={{ width: "100%", maxWidth: 600 }}>
      ...
      <div style={{ ...S.card, padding: 28 }}>
        <h2 style={{ fontSize: 18, fontWeight: 700, color: "#f1f5f9", marginBottom: 6 }}>Edit External Linux Server</h2>
        <p style={{ fontSize: 13, color: "#64748b", marginBottom: 20 }}>Modify SSH credentials or connection parameters.</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: 18 }}>
            ...
            <input 
              ...
              style={S.input} 
              placeholder="e.g. C:/keys/my-server.pem" 
              required
            />
          </div>
